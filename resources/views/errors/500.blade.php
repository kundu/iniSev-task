...
<main>
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        <h1>505</h1>
        <h2>UH OH! Its our fault.</h2>
        <p>We are trying to fix this out. By this time you can explore more by clicking home buttom.
        </p>
        <a href="{{ route('frontend.home') }}" class="btn green">Home</a>
      </div>
    </div>
  </div>
</main>
